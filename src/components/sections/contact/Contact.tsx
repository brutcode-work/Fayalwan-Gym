        ...
        <div className="contact-card">
          <div className="contact-info-panel">
            ...
            <p className="panel-intro">
              Have questions about memberships, facilities, or training
              programs? Stop by or reach out to us directly.
            </p>
            ...
            <div className="info-items-list">
              <div className="info-item">
                ...
                <div className="info-text">
                  <h4>Our Location</h4>
                  <p>
                    First Floor, SeaPearl Building, above South Indian Bank,
                    Mukkolakkal, P. O, Kulathoor, Thiruvananthapuram, Kerala
                    695582
                  </p>
                </div>
              </div>
              ...
              <div className="info-item">
                ...
                <div className="info-text">
                  <h4>Get There</h4>
                  <p>
                    ~22 mins travel time from Thiruvananthapuram City Center
                  </p>
                </div>
              </div>
              ...
              <div className="info-item">
                ...
                <div className="info-text">
                  <h4>Call Us</h4>
                  <p>
                    <a href="tel:09538116677">095381 16677</a>
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="contact-timing-panel">
            ...
            <p className="panel-intro">
              Plan your workouts around our opening hours. Our trainers are
            ...
            <div className="timings-list">
              {TIMINGS.map((t) => {
                ...
                return (
                  <div
                    key={t.day}
                    className={`timing-row ${isToday ? "today-active" : ""} ${t.closed ? "day-closed" : ""}`}
                  >
