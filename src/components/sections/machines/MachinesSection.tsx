...
const gymMachines: GymMachine[] = [
  {
    ...
    thumbImg:
      "https://images.unsplash.com/photo-1578762560072-053146e6a895?q=80&w=600&auto=format&fit=crop",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    coverImg:
      "https://images.unsplash.com/photo-1517838277536-f5f99be501cd?q=80&w=1200&auto=format&fit=crop",
    thumbImg:
      "https://images.unsplash.com/photo-1574680131975-40de145b6f83?q=80&w=600&auto=format&fit=crop",
  },
  {
    id: 10,
...
const MachinesSection = () => {
  ...
  return (
    <section ref={container} id="machines" className="machines-section">
      <div className="bg-huge-text">{currentMachine.name}</div>
